...
#include "U8glib.h"
U8GLIB_SSD1306_128X64 display(U8G_I2C_OPT_NO_ACK);  // Display which does not send ACK
...
void drawIcons() {
  ...
  if(volume==0) {
    ...
    for(uint8_t i=volumeMin+10;i<volume+10;i=i+10) {
      display.drawCircle(x+6, y+4, i/6, U8G_DRAW_UPPER_RIGHT);
      display.drawCircle(x+6, y+4, i/6, U8G_DRAW_LOWER_RIGHT);
    }
  }
